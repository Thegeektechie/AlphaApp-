...
int OverAllLength = inputOneLength + inputTwoLength;

Console.WriteLine("The addition of your First and Second Input is " + OverAllLength);

  int Multiple	= OverAllLength * 3;
  int Addition = OverAllLength + 20;
  Console.WriteLine((OverAllLength > 20) ? "The resultant value is more than 20, so therefore the length of the 2 input multiply by 3 is " + Multiple: "The resultant value is more than 20, so therefore the length of the 2 input + 20 is " + Addition);
...
Console.WriteLine("Solution");
Console.WriteLine("  ");
Console.WriteLine("Enter any word of your choice");
string str1 = Console.ReadLine();
int word = (int)str1[2];
int str1length = str1.Length;
int value = word + str1length;
char character = (char)value;
Console.WriteLine("The word you enter is " + str1);
Console.WriteLine(str1 + " has " + str1length + " characters");
Console.WriteLine("The third character of your input is " + word);
Console.WriteLine("The addition of the value of the third index and the whole string is " + value);
Console.WriteLine("The converson of the result to a character is letter " + character);
...
{
  Console.WriteLine("You have entered the correct answer");
}
else{
  Console.WriteLine("You have entered the wrong answer, The correct answer is " + result + "Relax and calculate well next time");
}
